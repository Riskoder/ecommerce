export function Nosotros() {
  ...
  <div class="nosotros-cuerpo"> 
    <h1>
      ...
      <p>
      Somos una tienda dedicada a la moda y el estilo, ofreciendo ropa de calidad, zapatillas exclusivas y accesorios como relojes que marcan la diferencia. Nuestro objetivo es acompañar a cada cliente en la creación de un look único, moderno y versátil, adaptado a cada ocasión.</p>
      <br>
    <h2>🎯 Misión</h2>
